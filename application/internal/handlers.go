...
func LoginHandler(challengeService ChallengeService) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		*/
		...
		challenge, _ := challengeService.GenerateChallenge(pubkey)
...
func VerifyHandler(challengeService ChallengeService) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		// Ensure it is a POST request
		if r.Method != http.MethodPost {
		...
		if !challengeService.HasActiveChallenge(publicKey) {
		...
		valid, _ := challengeService.VerifySignature(publicKey, signature)
		if !valid {
